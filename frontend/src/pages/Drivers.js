...
const initialDrivers = [
  { id: 1, name: "Alex", license_number: "DL-88215", license_category: "LMV", license_expiry_date: "2028-12-01", contact_number: "9876xxxxxx", safety_score: 96, status: "Available" },
  { id: 2, name: "John", license_number: "DL-49120", license_category: "HMV", license_expiry_date: "2025-03-01", contact_number: "9822xxxxxx", safety_score: 81, status: "Suspended" },
  { id: 3, name: "Priya", license_number: "DL-77031", license_category: "LMV", license_expiry_date: "2027-01-01", contact_number: "9180xxxxxx", safety_score: 99, status: "On Trip" },
  { id: 4, name: "Suresh", license_number: "DL-90045", license_category: "HMV", license_expiry_date: "2027-01-01", contact_number: "9440xxxxxx", safety_score: 88, status: "Available" },
];
...
export default function Drivers() {
  ...
  const handleAddDriver = (e) => {
    ...
    if (drivers.some((d) => d.license_number === form.license_number)) {
      setFormError("License number already exists");
      return;
    }
